...
export default function About() {
    return (
        <>
            <section id="home" className="min-h-[86%] flex justify-between p-2 pb-0 m-2 items-center w-full  border-b border-[rgb(246,191,52)]">
      ...
      text-[4.25rem] m-4 ">Lucas Lourenço</h2>
            ...
            <h2 className='m-4 p-4 text-4xl leading-8 flex flex-col items-center gap-6'> SOBRE MIM</h2>

            <section id="about" className="
        w-full flex justify-between p-2 pb-0 m-2 items-center border-b border-[rgb(246,191,52)] ">
                <div className="w-1/2"> 
                    <img
                        src={illustration}
