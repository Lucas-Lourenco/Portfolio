...
export default function SkillCard({ skill }: SkillCardProps) {
  ...
  return (
    <section className="border border-[rgb(70,63,45)] hover:border-amber-400 p-4 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 m-auto flex flex-col md:flex-row  justify-center items-center gap-4 mb-2">
